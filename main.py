...
@discord.app_commands.checks.has_permissions(administrator=True) # 🔒 حماية الأمر: للمسؤولين فقط
...
# دالة للتعامل في حال حاول عضو عادي استخدام الأوامر
@send_dm.error
@status.error
@stop.error
async def missing_permissions_error(interaction: discord.Interaction, error):
    if isinstance(error, discord.app_commands.MissingPermissions):
        await interaction.response.send_message("❌ عذراً، هذا الأمر مخصص للمسؤولين (Administrator) فقط!", ephemeral=True)
